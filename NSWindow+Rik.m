  ...
  switch (button)
    {
      case NSWindowCloseButton:
        ...
        [newButton setBaseColor: [NSColor colorWithCalibratedRed: 0.8 green: 0.0 blue: 0.00 alpha: 1]];
      ...
      case NSWindowMiniaturizeButton:
        newButton = [[RikWindowButton alloc] init];
        [newButton setBaseColor: [NSColor colorWithCalibratedRed: 0.9 green: 0.7 blue: 0.0 alpha: 1]];
